...
// Get All CATEGORYs
export const ALL_CATEGORY_REQUEST = "ALL_CATEGORYS_REQUEST";
export const ALL_CATEGORY_SUCCESS = "ALL_CATEGORYS_SUCCESS";  
export const ALL_CATEGORY_RESET = "ALL_CATEGORYS_RESET";     
export const ALL_CATEGORY_FAIL = "ALL_CATEGORYS_FAIL";        
